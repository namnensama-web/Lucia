        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            {isEditing ? (
              ...
              <p className="text-gray-600 dark:text-gray-400 text-sm">{contactText}</p>
            )}
          </div>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700 text-center text-gray-600 dark:text-gray-400 text-sm">
          {isAdmin() ? (
            <div className="flex justify-center items-center">
              <p>
                © {currentYear}
                {localStorage.getItem("footerCopyright") || "我的个人博客"}. 保留所有权利.
              </p>
              <button
                onClick={() => {
                  const newText = prompt(
                    "请输入版权信息:",
                    localStorage.getItem("footerCopyright") || "我的个人博客"
                  );
                  if (newText !== null) {
